...
![alt text](img/create%20vpc.png)
![alt text](img/Screenshot%20(167)%20create%20vpc.png)
![](img/Screenshot%20(168)%20create%20vpc%202.png)

- Now we create an Internet Gateway
![alt text](img/Screenshot%20(169)%20create%20internet%20gateway.png)

![alt text](img/Screenshot%20(171)%20create%20internet%20gateway%202.png)

![alt text](img/Screenshot%20(172)%20create%20internet%20gateway%203.png)

![alt text](img/Screenshot%20(173)%20create%20gateway%204.png)
...
![alt text](img/Screenshot%20(175)%20create%20a%20public%20subnet.png)

![alt text](img/Screenshot%20(176)%20create%20public%20subnet%202.png)
![alt text](img/Screenshot%20(177)%20create%20public%20subnet%203.png)
![alt text](img/Screenshot%20(179)%20add%20second%20subnet.png)
![alt text](img/Screenshot%20(180)%20add%20second%20subnet%202.png)
![alt text](img/Screenshot%20(181)%20create%20subnet.png)
![alt text](img/Screenshot%20(183)%20subnet%20outlook.png)
...
![alt text](img/Screenshot%20(184)%20all%20subnets%20created.png)
...
![text](img/Screenshot%20(185)%20create%20public%20route%20table.png)

- Give it a name and select the VPC you created earlier

![text](img/Screenshot%20(186)%20name%20public%20rt.png)

- Let's assocaite our public subnet to our route table
![text](img/Screenshot%20(205)%20associate%20pb%20subnet%20to%20rt.png)
![text](img/Screenshot%20(206)%20associate%20pb%20subnet%20to%20rt%202.png)

- We add 3 public subnets (prod-web-public a,b,c)
![text](img/Screenshot%20(207)%203%20public%20subnets%20(abc).png)
...
![alt text](img/Screenshot%20(187)%20completion%20of%20other%20rts%20and%20their%20subnet%20association.png)
...
![text](img/Screenshot%20(208)%20create%20NAT%20gateway%20.png)

- select a subnet and allocate an elastic ip

![text](img/Screenshot%20(211)%20subnet%20and%20elastic%20ip.png)

###  Now we will add the NAT gateway to our route tables one by one:

![alt text](img/Screenshot%20(212)%20NAT%20gateway%20to%20platform%20rt.png)

- add route to each route table , we are adding to platorm route table now
![alt text](img/Screenshot%20(213)%20add%20route%20to%20platform%20rt.png)

- for Destination select 0.0.0.0/0
![alt text](img/Screenshot%20(214)%20Destination%20column.png)

- for the Target select NAT gateway
![alt text](img/Screenshot%20(215)%20target%20column.png)
- select the NAT gateway created earlier and save changes
![alt text](img/Screenshot%20(216)%20target%20column%202.png)

- Notice the status of the NAT gateway it's active
![alt text](img/Screenshot%20(217)%20active%20status%20of%20NAT%20gateway.png)
...
- >[NOTE] I followed the same step I used with the previous 4 route tables *except* I attached Internet Gateway in the public RT instead of NAT gateway I used in the previous 4.

![alt text](img/Screenshot%20(218)%20public%20rt%20target%20column=internet%20gateway%20.png)
![alt text](img/Screenshot%20(219)%20internet%20gateway%20for%20public%20rt%202.png)
![](img/Screenshot%20(220)%20active%20status%20of%20public%20rt.png)
...
![alt text](img/Screenshot%20(198)%20AWS%20VPC%20Topology.png)

![alt text](img/Screenshot%20(199)%20AWS%20VPC%20Topology%202.png)
...
![alt text](img/Screenshot%20(200)%20create%20network%20ACL.png)

![alt text](img/Screenshot%20(221)%20create%20network%20ACL%202.png)

![alt text](img/Screenshot%20(204)%20create%20network%20ACL%203.png)
